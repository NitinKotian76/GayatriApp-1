from main.formmod.CrudForm import formFieldData as ffd
from main.formmod.LoadForm import Filedata
from main.formmod.ValidateForm import ValidatorInstances as vld
...
class form_config():
    ...
    def create_form(self,*args,**kwargs):
            ...
            ff = ffd(formName,Access_rights,tables) 

    def save_in_cache(self,*args,**kwargs):
            cachestore.set(sessionid,ff.FieldDataDict)
