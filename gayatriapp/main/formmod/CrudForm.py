#TODO: when clicked the method should already have a draft file saved in the path the click should only trigger an append function and the draft form should be saved the next click should do the same 
#TODO: make things neat
