...
def addFieldshtml():
    ...
    return(BF.container(children='<a href="#" class="w3-btn w3-ripple w3-cell w3-blue" hx-get="/main/field_setup" hx-target="#modalView" hx-swap="innerHTML" onclick=document.getElementById("modalView").style.display="block">add field</a><a href="#" class="w3-btn w3-ripple w3-cell w3-blue" hx-get="/main/field_setup" hx-target="#modalView" hx-swap="innerHTML">add Column</a>'))
...
def profilehtml():
    return(
            BF.container(
                ...
                BF.textInput(
                    label="Name",attr='disabled', 
                    cssclass="w3-border-0"
                    )+
                BF.textInput(
                    label="groups",
                    attr='disabled', 
...
def formConfightml():
    ...
    return(BF.textInput(
                    ...
                    BF.button(
                        label="Submit",
                        attr='hx-post="/main/form_setup" hx-target="#mainform" hx-swap="innerHTML" onclick=document.getElementById("modalView").style.display="none"'
                        )+
                    BF.button(
                        label="Cancel",
...
def fieldConfightml():
    ...
    return(
            BF.modalContainer(
                ...
                BF.button(
                    label="Submit",
                    attr='hx-post="/main/field_setup" hx-target="#mainform" hx-swap="none"'
                    )+
                BF.button(
                    label="Cancel",
                    attr='onclick=document.getElementById("modalView").style.display="none"'
...
def formDeletehtml():
    ...
    return(
            BF.modalContainer(
                    ...
                    BF.button(label="Delete",
                              attr='hx-delete="/main/form_setup" hx-vals=jsonvalue hx-target="none" hx-swap="none"'
                              )+
                    BF.button(
                        label="Cancel",
                        attr='onclick=document.getElementById("modalView").style.display="none"'
...
def formEdithtml():
    ...
    return(
            BF.modalContainer(
                    children=formlistview+
                    BF.button(label="Edit",
                              attr='hx-delete="/main/form_setup" hx-vals=jsonvalue hx-target="none" hx-swap="none"')+
                    BF.button(label="Cancel",
                              attr='onclick=document.getElementById("modalView").style.display="none"')
                    ),
            )
