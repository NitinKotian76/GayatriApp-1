...
millsoft_master_urlpatterns = [
    ...
    path("msupplier/<uuid:pk>/update/", millsoft_master_view.MSupplier_update.as_view(),
         name="MSupplier_update"),
    path("msupplier/<uuid:pk>/delete/", millsoft_master_view.MSupplier_delete.as_view(),
...
millsoft_transact_urlpatterns = [
    ...
    path("tindent/create/", millsoft_transaction_view.TIndent_create.as_view(),
         name="TIndent_create"),
    path("tindent/<uuid:pk>/update/", millsoft_transaction_view.TIndent_update.as_view(),
         name="TIndent_update"),
    path("tindent/<uuid:pk>/delete/", millsoft_transaction_view.TIndent_delete.as_view(),
         name="TIndent_delete"),
    ...
    path("tproductionbck/<uuid:pk>/update/", millsoft_transaction_view.TProduction_bck_update.as_view(),
         name="TProduction_bck_update"),
    path("tproductionbck/<uuid:pk>/delete/", millsoft_transaction_view.TProduction_bck_delete.as_view(),
