...
millsoft_master_urlpatterns = [
    path("magent/create/", millsoft_master_view.MAgent_create.as_view(),
         name="MAgent_create"),
    path("magent/<uuid:pk>/update/", millsoft_master_view.MAgent_update.as_view(),
         name="MAgent_update"),
    path("magent/<uuid:pk>/delete/", millsoft_master_view.MAgent_delete.as_view(),
         name="MAgent_delete"),
    path("magent/", millsoft_master_view.MAgent_list.as_view(), name="MAgent_list"),
    path("munit/create/", millsoft_master_view.MUnit_create.as_view(),
         name="MUnit_create"),
    path("munit/<uuid:pk>/update/", millsoft_master_view.MUnit_update.as_view(),
         name="MUnit_update"),
    path("munit/<uuid:pk>/delete/", millsoft_master_view.MUnit_delete.as_view(),
         name="MUnit_delete"),
    path("munit/", millsoft_master_view.MUnit_list.as_view(), name="MUnit_list"),
    path("mcustomer/create/", millsoft_master_view.MCustomer_create.as_view(),
         name="MCustomer_create"),
    path("mcustomer/<uuid:pk>/update/", millsoft_master_view.MCustomer_update.as_view(),
         name="MCustomer_update"),
    path("mcustomer/<uuid:pk>/delete/", millsoft_master_view.MCustomer_delete.as_view(),
         name="MCustomer_delete"),
    path("mcustomer/", millsoft_master_view.MCustomer_list.as_view(),
         name="MCustomer_list"),
    path("company/", millsoft_master_view.Company_list.as_view(), name="Company_list"),
    path("company/create/", millsoft_master_view.Company_create.as_view(), name="Company_create"),
    path("company/<uuid:pk>/update/", millsoft_master_view.Company_update.as_view(), name="Company_update"),
    path("company/<uuid:pk>/delete/", millsoft_master_view.Company_delete.as_view(), name="Company_delete"),
    path("mexportfields/create/", millsoft_master_view.MExportFields_create.as_view(),
         name="MExportFields_create"),
    path("mexportfields/<uuid:pk>/update/", millsoft_master_view.MExportFields_update.as_view(),
         name="MExportFields_update"),
    path("mexportfields/<uuid:pk>/delete/", millsoft_master_view.MExportFields_delete.as_view(),
    ...
    path("mitem/create/", millsoft_master_view.MItem_create.as_view(),
         name="MItem_create"),
    path("mitem/<uuid:pk>/update/", millsoft_master_view.MItem_update.as_view(),
         name="MItem_update"),
    path("mitem/<uuid:pk>/delete/", millsoft_master_view.MItem_delete.as_view(),
         name="MItem_delete"),
    ...
    path("mitemcategory/<uuid:pk>/update/", millsoft_master_view.MItemCategory_update.as_view(),
         name="MItemCategory_update"),
    path("mitemcategory/<uuid:pk>/delete/",
    ...
    path("mplusminushead/<uuid:pk>/update/",
         millsoft_master_view.MPlusMinusHead_update.as_view(), name="MPlusMinusHead_update"),
    path("mplusminushead/<uuid:pk>/delete/", millsoft_master_view.MPlusMinusHead_delete.as_view(),
    ...
    path("mshade/create/", millsoft_master_view.MShade_create.as_view(),
         name="MShade_create"),
    path("mshade/<uuid:pk>/update/", millsoft_master_view.MShade_update.as_view(),
         name="MShade_update"),
    path("mshade/<uuid:pk>/delete/", millsoft_master_view.MShade_delete.as_view(),
         name="MShade_delete"),
...
millsoft_transact_urlpatterns = [
    ...
    path("tproduction/<uuid:pk>/delete/",
    ...
    path("texportdetails/<uuid:pk>/update/", millsoft_transaction_view.TExportDetails_update.as_view(),
         name="TExportDetails_update"),
    path("texportdetails/<uuid:pk>/delete/", millsoft_transaction_view.TExportDetails_delete.as_view(),
    ...
    path("tinvoice/<uuid:pk>/update/", millsoft_transaction_view.TInvoice_update.as_view(),
    ...
    path("tproductionreel/<uuid:pk>/update/", millsoft_transaction_view.TProductionReel_update.as_view(),
         name="TProductionReel_update"),
    path("tproductionreel/<uuid:pk>/delete/", millsoft_transaction_view.TProductionReel_delete.as_view(),
